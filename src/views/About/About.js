            ...
            <TopSpan message="from my heart to yours" showImage={false}/>
                ...
                <div className="topLevelparent">
                    ...
                    <p className="aboutMeVerbage">While navigating the road to recovery, I noticed the plethora of Christian books on divorce; yet:
                     <ul>
                        <li>There was little on how to heal from divorce AND the judgment from your church peers or lay church counselors.</li> 
                        <li>Very little to help me rebuild my identity as His “divorced” daughter.</li>
                        <li>No proclamations that I was still useful to Him.</li> 
                        <li>And…no one told me I still had a destiny in the Kingdom of God or that my call still matteredto the Lord.</li>
                    </ul>  
                    </p>
